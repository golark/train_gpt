...
def sample_from_model(model, enc, num_return_seq=4, max_len=32, prompt="Hello, I'm a language model,"):
    ...
    Args:
        ...
        num_return_seq: Number of sequences to generate
    ...
    while xgen.size(1) < max_len:
        ...
        next_token_idx = torch.multinomial(topk_probs, 1, generator=sample_rng)
        next_token = torch.gather(topk_idx, 1, next_token_idx)
